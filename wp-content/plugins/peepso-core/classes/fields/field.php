...
class PeepSoField
{
	...
	protected function _render_form_input( )
	{
		...
		$ret .= '<input type="text" value="' . $this->value . '"' . $this->_render_input_args() . $this->_render_required_args() . '>';
	...
	protected function _render_form_input_register( )
	{
		...
		$ret  = '<div class="ps-form__field-inner">';
		$ret .= '<input type="text" value="' . $this->value . '"' . $this->_render_input_register_args() . $this->_render_required_args() . '>';
		$ret .= '<div class="ps-charcount ps-charcount--input ps-js-counter" style="display:none"></div>';
		$ret .= '</div>';
