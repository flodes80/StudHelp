...
<div class="row sociallogin__admin">
    ...
    <div class="box">
        <div class="clearfix"></div>
        <div class="col-md-3 box-label"><?php _e('Import avatar', 'peepso-core'); ?></div>
        <div class="col-md-3">
            <?php
            $import_avatar = PeepSo::get_option('social_login_import_avatar', 1);
            ?>
            <select class="form-control field" data-field="avatar">
                <option value="1"<?php echo ($import_avatar == 1) ? ' selected' : ''; ?>><?php _e('Yes', 'peepso-core'); ?></option>
                <option value="0"<?php echo ($import_avatar == 0) ? ' selected' : ''; ?>><?php _e('No', 'peepso-core'); ?></option>
            </select>
        </div>
        <div class="clearfix"></div>
    </div>
