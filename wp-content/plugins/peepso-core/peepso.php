            ...
            if (empty($check_plugins)) {
                ...
                if(strlen(get_transient('peepso_is_offline'))) {
                    ...
                    if(PeepSoApiRateLimit::check('edd_products_json',10)) {
                        ...
                        $response = wp_remote_get('https://www.peepso.com/products.json?version=' . PeepSo::PLUGIN_VERSION . '&locale=' . get_locale() . '&hide_bundle_offer=' . PeepSo::get_option('bundle', 0), array('timeout' => 10));
